---
name: crm-lead-nurture-ai
description: Run CRM / Lead Nurture AI ("The Pursuer") — Built for the high-value bookings that matter most: group bookings, multi-room reservations, and VIP guests.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Pursuer", "/crm-lead-nurture-ai", "check the queue", "what is waiting for me", "approve that draft".
---

# CRM / Lead Nurture AI

Runs CRM / Lead Nurture AI and works its review queue. Everything happens from the repo
